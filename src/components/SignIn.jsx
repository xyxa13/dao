...
import { Wallet, Shield, Zap, ArrowRight, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4">
        <motion.div
          className="bg-gray-900/50 backdrop-blur-xl border border-cyan-500/30 text-white p-8 rounded-3xl shadow-2xl w-full max-w-md"
            ...
            {isAuthenticated ? (
              ...
              >
                ...
                <div className="space-y-3">
                  <motion.button
                    ...
                    className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 transition-all font-semibold text-white shadow-lg flex items-center justify-center space-x-2 font-mono"
                  >
                    <span>ENTER DAOVERSE</span>
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={handleLogin}
                  disabled={isLoading}
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 transition-all font-semibold text-white shadow-lg disabled:opacity-50 flex items-center justify-center space-x-2 font-mono"
                >
                  {isLoading ? (
                    <>
